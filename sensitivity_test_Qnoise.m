...
for yy = 1:20
    ...
    if yy > 1
        filename_last = [new_path 'main_test5new_Q_noise_',num2str(yy-1),'.mat'];
    ...
    for i = 1:N
        ...
        taux =  gammaa*(XX + (K_phy_old - R_phy_old))*1.5556;
        ...
        b = 0.26*cc1 * zeta * alpha_q *temp_alphaq.*season_alphaq;
        ...
        if mod(i,gap) == 0
            ...
            if j == N/gap
               ...
               filenames = [new_path 'main_test5new_Qnoise_',num2str(yy),'.mat'];
